...
if (range>400){
  ...
  if (range>50){
    DatasetRange <- c("0","1-2","3-5","6-10","11-15","16-20","21-24","25-30","31-40","41-50",">50")
    BreakRange <- list(-1,0,2,5,10,15,20,24,30,40,50)
  } else{
  if (range>40){
  ...
  DatasetRange <- c("0","1","2","3","4","5","6",">7")
  BreakRange <- list(-1,0,1,2,3,4,5,6)
  }}}}}}}